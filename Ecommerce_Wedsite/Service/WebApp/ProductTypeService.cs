...
{
    public interface IProductTypeService // Tạo Interface
    {

        Task<ResponseMessageObject<ProductType_ViewModel>> Service_Test(); //Model lớn chứa Model nhỏ. Tạo Phương Thức     
    }
    public class ProductTypeService : IProductTypeService // Thừa kế các thuộc tính từ Interface 
    {
        private readonly IConfigManagerService _configuration;
        public ProductTypeService(IConfigManagerService configuration)
        {
